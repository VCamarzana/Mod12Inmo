...
exports.insertContactForm = exports.getPropertyDetail = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api");
var propertiesUrl = "".concat(url, "/properties");
var contactUrl = "".concat(url, "/contact");
var getPropertyDetail = function getPropertyDetail(id) {
  return _axios.default.get("".concat(propertiesUrl, "/").concat(id)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
exports.getPropertyDetail = getPropertyDetail;
var insertContactForm = function insertContactForm(form) {
  return _axios.default.post(contactUrl, form).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/property-detail/property-detail.helpers.js":[function(require,module,exports) {
"use strict";
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/property-detail/property-detail.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapPropertyDetailListFromApiToVM = exports.mapPropertyDetailFromApiToVM = void 0;
var mapPropertyDetailListFromApiToVM = function mapPropertyDetailListFromApiToVM(propertyList) {
  return propertyList.map(function (property) {
    return mapPropertyDetailFromApiToVM(property);
  });
};
exports.mapPropertyDetailListFromApiToVM = mapPropertyDetailListFromApiToVM;
var getEquipments = function getEquipments(property, equipments) {
  return property.equipmentIds.map(function (id) {
    var equipment = equipments.find(function (equipment) {
      return equipment.id === id;
    });
    return equipment ? equipment.name : null;
  });
};
var mapPropertyDetailFromApiToVM = function mapPropertyDetailFromApiToVM(property, equipments) {
  return {
    id: property.id,
...
exports.mapPropertyDetailFromApiToVM = mapPropertyDetailFromApiToVM;
...
},{}],"pages/property-detail/property-detail.validators.js":[function(require,module,exports) {
"use strict";
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"common/api/common.api.js":[function(require,module,exports) {
"use strict";
...
},{"./common.api":"common/api/common.api.js"}],"pages/property-detail/property-detail.js":[function(require,module,exports) {
"use strict";
...
var _propertyDetail4 = require("./property-detail.validators");
...
Promise.all([(0, _propertyDetail.getPropertyDetail)(params.id), (0, _api.getEquipmentsList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
    propertyDetails = _ref2[0],
    equipments = _ref2[1];
  loadPropertyDetails(propertyDetails, equipments);
});
var loadPropertyDetails = function loadPropertyDetails(propertyDetails, equipments) {
  var vmPropertyDetails = (0, _propertyDetail3.mapPropertyDetailFromApiToVM)(propertyDetails, equipments);
  (0, _propertyDetail2.setPropertyValues)(vmPropertyDetails);
};
var form = {
  email: "",
  message: ""
...
var onSave = function onSave() {
  (0, _propertyDetail.insertContactForm)(form);
