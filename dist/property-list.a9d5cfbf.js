...
var getPropertyList = function getPropertyList(queryParams) {
  return _axios.default.get("".concat(url, "?").concat(queryParams)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
exports.mapPropertyListFromApiToVM = exports.mapPropertyFromApiToVM = exports.mapFilterToQueryParams = void 0;
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"common/api/common.api.js":[function(require,module,exports) {
"use strict";
...
},{"./common.api":"common/api/common.api.js"}],"pages/property-list/property-list.js":[function(require,module,exports) {
"use strict";
...
function _iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
Promise.all([(0, _propertyList.getPropertyList)(), (0, _api.getSaleTypeList)(), (0, _api.getProvincesList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
    propertyList = _ref2[0],
    saleTypeList = _ref2[1],
    provincesList = _ref2[2];
  loadPropertyList(propertyList);
  (0, _propertyList3.setOptions)(saleTypeList, "select-sale-type", "Tipo de operación");
  (0, _propertyList3.setOptions)(provincesList, "select-province", "Dónde");
...
var loadPropertyList = function loadPropertyList(propertyList) {
  var vmPropertyList = (0, _propertyList2.mapPropertyListFromApiToVM)(propertyList);
