...
exports.insertNewProperty = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/properties");
var insertNewProperty = function insertNewProperty(newProperty) {
...
},{"axios":"../node_modules/axios/index.js"}],"pages/upload-property/upload-property.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapNewPropertyListFromVMToApi = exports.mapNewPropertyFromVMToApi = void 0;
...
var mapNewPropertyListFromVMToApi = function mapNewPropertyListFromVMToApi(newPropertyList) {
  return newPropertyList.map(function (newProperty) {
    return mapNewPropertyFromVMToApi(newProperty);
  });
};
exports.mapNewPropertyListFromVMToApi = mapNewPropertyListFromVMToApi;
var mapNewPropertyFromVMToApi = function mapNewPropertyFromVMToApi(property) {
...
exports.mapNewPropertyFromVMToApi = mapNewPropertyFromVMToApi;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/upload-property/upload-property.validators.js":[function(require,module,exports) {
"use strict";
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-is-number-validator":"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js","@lemoncode/fonk-is-url-validator":"../node_modules/@lemoncode/fonk-is-url-validator/dist/@lemoncode/fonk-is-url-validator.esm.js","@lemoncode/fonk-array-required-validator":"../node_modules/@lemoncode/fonk-array-required-validator/dist/@lemoncode/fonk-array-required-validator.esm.js"}],"common/api/common.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSaleTypeList = exports.getProvincesList = exports.getEquipmentsList = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api");
var saleTypeListUrl = "".concat(url, "/saleTypes");
var equipmentsListUrl = "".concat(url, "/equipments");
var provincesListUrl = "".concat(url, "/provinces");
...
var getEquipmentsList = function getEquipmentsList() {
  return _axios.default.get(equipmentsListUrl).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
exports.getEquipmentsList = getEquipmentsList;
var getProvincesList = function getProvincesList() {
  return _axios.default.get(provincesListUrl).then(function (_ref3) {
    var data = _ref3.data;
    return data;
  });
};
exports.getProvincesList = getProvincesList;
},{"axios":"../node_modules/axios/index.js"}],"common/api/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var _common = require("./common.api");
...
},{"./common.api":"common/api/common.api.js"}],"pages/upload-property/upload-property.js":[function(require,module,exports) {
"use strict";
...
var _uploadProperty4 = require("./upload-property.validators");
...
function _iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
Promise.all([(0, _api.getSaleTypeList)(), (0, _api.getEquipmentsList)(), (0, _api.getProvincesList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
    saleTypesList = _ref2[0],
    equipmentsList = _ref2[1],
    provincesList = _ref2[2];
  (0, _uploadProperty.setCheckboxList)(saleTypesList, "saleTypes");
  (0, _uploadProperty.setCheckboxList)(equipmentsList, "equipments");
  (0, _uploadProperty.setOptionList)(provincesList, "province");
});
var newProperty = {
  id: "",
  title: "",
...
(0, _helpers.onUpdateField)("title", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("title", newProperty.title).then(function (result) {
...
(0, _helpers.onUpdateField)("notes", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("notes", newProperty.notes).then(function (result) {
...
(0, _helpers.onUpdateField)("email", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("email", newProperty.email).then(function (result) {
...
(0, _helpers.onUpdateField)("phone", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("phone", newProperty.phone).then(function (result) {
...
(0, _helpers.onUpdateField)("price", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("price", newProperty.price).then(function (result) {
...
(0, _helpers.onUpdateField)("saleTypes", function (event) {
  ...
  var index = newProperty.saleTypeIds.indexOf(value);
  isChecked ? newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    saleTypeIds: [].concat(_toConsumableArray(newProperty.saleTypeIds), [value])
  }) : newProperty.saleTypeIds.splice(index, 1);
  _uploadProperty4.formValidation.validateField("saleTypes", newProperty.saleTypeIds).then(function (result) {
...
(0, _helpers.onUpdateField)("address", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("address", newProperty.address).then(function (result) {
...
(0, _helpers.onUpdateField)("city", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("city", newProperty.city).then(function (result) {
...
(0, _helpers.onUpdateField)("province", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("province", newProperty.provinceId).then(function (result) {
...
(0, _helpers.onUpdateField)("squareMeter", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("squareMeter", newProperty.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)("rooms", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("rooms", newProperty.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)("bathrooms", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("bathrooms", newProperty.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)("locationUrl", function (event) {
  ...
  _uploadProperty4.formValidation.validateField("locationUrl", newProperty.locationUrl).then(function (result) {
...
(0, _helpers.onUpdateField)("equipments", function (event) {
  var value = event.target.value;
  var isChecked = event.target.checked;
  var index = newProperty.equipmentIds.indexOf(value);
  isChecked ? newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    equipmentIds: [].concat(_toConsumableArray(newProperty.equipmentIds), [value])
  }) : newProperty.equipmentIds.splice(index, 1);
  _uploadProperty4.formValidation.validateField("equipments", newProperty.equipmentIds).then(function (result) {
...
(0, _helpers.onSubmitForm)("insert-feature-button", function () {
  ...
  if (value) {
    newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
      mainFeatures: [].concat(_toConsumableArray(newProperty.mainFeatures), [value])
    });
    var id = (0, _uploadProperty.formatDeleteFeatureButtonId)(value);
    (0, _uploadProperty.onAddFeature)(value);
    (0, _helpers.onSubmitForm)(id, function () {
      (0, _uploadProperty.onRemoveFeature)(value);
      var index = newProperty.mainFeatures.indexOf(value);
...
},{"../../common/helpers":"common/helpers/index.js","./upload-property.helpers":"pages/upload-property/upload-property.helpers.js","./upload-property.api":"pages/upload-property/upload-property.api.js","./upload-property.mappers":"pages/upload-property/upload-property.mappers.js","./upload-property.validators":"pages/upload-property/upload-property.validators.js","../../common/api":"common/api/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
